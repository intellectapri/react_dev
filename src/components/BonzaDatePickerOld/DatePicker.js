...
var _entry = _interopRequireDefault(
  require("react-calendar/dist/entry.nostyle"),
);
            ...
            return _react.default.createElement(
              ...
              clearIcon !== null &&
                _react.default.createElement(
                  ...
                  {
                    className: ""
                      .concat(baseClassName, "__clear-button ")
                      .concat(baseClassName, "__button"),
                    disabled: disabled,
                    onClick: this.clear,
              ...
              calendarIcon !== null &&
                _react.default.createElement(
                  ...
                  {
                    className: ""
                      .concat(baseClassName, "__calendar-button ")
                      .concat(baseClassName, "__button"),
                    disabled: disabled,
        ...
        },
        {
          ...
          value: function getTileDisabled(_ref) {
            ...
            if (view === "month" && this.props.allotments) {
              ...
              return !(
                this.props.allotments[yearIndex] &&
                this.props.allotments[yearIndex][monthIndex] &&
                this.props.allotments[yearIndex][monthIndex][dayIndex]
              );
            } else {
              return false;
            }
        ...
        },
        {
          ...
          value: function renderCalendar() {
            ...
            var _this$props3 = this.props,
              ...
              calendarProps = _objectWithoutProperties(_this$props3, [
                "calendarClassName",
                "className",
                "onChange",
                "value",
              ...
              _extends(
                {
                  className: (0, _mergeClassNames.default)(
                    ...
                    ""
                      .concat(baseClassName, "--")
                      .concat(disabled ? "disabled" : "enabled"),
                    className,
                  ),
                },
                this.eventProps,
...
DatePicker.propTypes = _objectSpread({}, _entry.default.propTypes, {
  calendarClassName: _propTypes.default.oneOfType([
