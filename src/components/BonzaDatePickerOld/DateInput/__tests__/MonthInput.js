...
describe("MonthInput", function () {
  ...
  it("renders an input", function () {
    var component = (0, _enzyme.mount)(
      _react.default.createElement(_MonthInput.default, defaultProps),
    );
  ...
  it('renders "0" given showLeadingZeros if day is <10', function () {
    ...
    expect(input.prop("className")).toContain(
      "".concat(defaultProps.className, "__input--hasLeadingZero"),
    );
  });
