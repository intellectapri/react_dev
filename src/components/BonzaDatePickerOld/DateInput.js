...
var getDetailValueFrom = function getDetailValueFrom(
  value,
  minDate,
  maxDate,
  maxDetail,
  ...
  var detailValueFrom = (0, _dates.getBegin)(
...
var getDetailValueTo = function getDetailValueTo(
  value,
  minDate,
  maxDate,
  maxDetail,
...
var getDetailValueArray = function getDetailValueArray(
  value,
  minDate,
  maxDate,
  maxDetail,
...
var _renderCustomInputs = function renderCustomInputs(
  placeholder,
  elementFunctions,
) {
  ...
  return placeholder.split(pattern).reduce(function (arr, element, index) {
    var divider =
      element && // eslint-disable-next-line react/no-array-index-key
  ...
  (function (_PureComponent) {
    ...
    function DateInput() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(DateInput)).call.apply(
          _getPrototypeOf2,
          [this].concat(args),
        ),
      );
      ...
      _defineProperty(
        ...
        function (event) {
          if (event.target === event.currentTarget) {
            ...
            var _event$target$childre = _slicedToArray(
      ...
      _defineProperty(
        ...
        function (event) {
          ...
          _this.setState(
            _defineProperty({}, name, value ? parseInt(value, 10) : null),
      ...
      _defineProperty(
        ...
        function () {
          ...
          if (
            formElements.every(function (formElement) {
      ...
      _defineProperty(_assertThisInitialized(_this), "renderDay", function () {
          ...
          value: function renderCustomInputs() {
            if (this.state.value !== null && this.state.value !== undefined) {
              return _react.default.createElement(
                ...
                (0, _moment.default)(this.state.value).format(
                  this.props.dataFormat ? this.props.dataFormat : "D MMM YYYY",
                ),
              );
            } else {
