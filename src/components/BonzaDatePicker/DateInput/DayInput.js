  ...
  (function (_PureComponent) {
    ...
    function DayInput() {
      ...
      return _possibleConstructorReturn(
        this,
        _getPrototypeOf(DayInput).apply(this, arguments),
      );
    }
          ...
          return [
            ...
            _react.default.createElement("input", {
              ...
              className: (0, _mergeClassNames.default)(
                "".concat(className, "__input"),
                "".concat(className, "__day"),
                hasLeadingZero &&
                  "".concat(className, "__input--hasLeadingZero"),
              ),
              disabled: disabled,
              name: name,
              max: maxDay,
      ...
      },
      {
        ...
        get: function get() {
          ...
          return (0, _utils.min)(
            ...
            maxDate &&
              year === (0, _dates.getYear)(maxDate) &&
              month === (0, _dates.getMonth)(maxDate) &&
              (0, _dates.getDay)(maxDate),
          );
        },
      },
      {
        ...
        get: function get() {
          ...
          return (0, _utils.max)(
            1,
            minDate &&
              year === (0, _dates.getYear)(minDate) &&
              month === (0, _dates.getMonth)(minDate) &&
              (0, _dates.getDay)(minDate),
          );
        },
      },
    ]);
