...
import {
  getUpcomingMiscReport,
  exportUpcomingMiscReport,
} from "../../middleware/api/reports";

class UpcomingMiscPurchsasesPage extends React.Component {
  constructor(props) {
    super(props);
    ...
    props.dispatch(setActivePageTitle(`Upcoming Misc Calendar`));
  }
...
UpcomingMiscPurchsasesPage.propTypes = {
  dispatch: PropTypes.func.isRequired,
};

export default UpcomingMiscPurchsasesPage;
